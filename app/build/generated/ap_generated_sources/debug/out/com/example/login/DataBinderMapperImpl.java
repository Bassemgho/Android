...
import com.example.login.databinding.FragmentAffichageBindingImpl;
...
import com.example.login.databinding.SignupBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_FRAGMENTAFFICHAGE = 2;

  private static final int LAYOUT_FRAGMENTBLANK = 3;

  private static final int LAYOUT_FRAGMENTSHOP = 4;

  private static final int LAYOUT_FRAGMENTSIGNINCAISSIER = 5;

  private static final int LAYOUT_LOGINTABFRAGMENT = 6;

  private static final int LAYOUT_SIGNUP = 7;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(7);

  static {
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.login.R.layout.activity_home, LAYOUT_ACTIVITYHOME);
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.login.R.layout.fragment_affichage, LAYOUT_FRAGMENTAFFICHAGE);
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.example.login.R.layout.signup, LAYOUT_SIGNUP);
  }
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_FRAGMENTAFFICHAGE: {
          if ("layout/fragment_affichage_0".equals(tag)) {
            return new FragmentAffichageBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for fragment_affichage is invalid. Received: " + tag);
        }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/fragment_affichage_0", com.example.login.R.layout.fragment_affichage);
      ...
      sKeys.put("layout/signup_0", com.example.login.R.layout.signup);
    }
  }
}
